...
static struct l2_level l2_freq_tbl[] __initdata = {
    ...
    [15] = { { 1242000, HFPLL, 1, 0x2E }, 1100000, 1100000, 5 },
    [16] = { { 1296000, HFPLL, 1, 0x30 }, 1100000, 1100000, 5 },
    [17] = { { 1350000, HFPLL, 1, 0x32 }, 1100000, 1100000, 5 },
	{ }
};

static struct acpu_level tbl_slow[] __initdata = {
	{ 1, {    81000, HFPLL, 0, 0x06 }, L2(0),   875000 },
	{ 1, {   162000, HFPLL, 0, 0x0C }, L2(0),   900000 }, 
	{ 1, {   270000, HFPLL, 0, 0x14 }, L2(0),   925000 }, 
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   950000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(4),   975000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),  1000000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(6),  1025000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(7),  1075000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(8),  1100000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(9),  1125000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(10), 1175000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(11), 1200000 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(12), 1225000 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(13), 1237500 },
...
static struct acpu_level tbl_nom[] __initdata = {
	...
	{ 1, {   162000, HFPLL, 0, 0x0C }, L2(0),   850000 }, 
	{ 1, {   270000, HFPLL, 0, 0x14 }, L2(0),   875000 }, 
	...
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(8),  1050000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(9),  1075000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(10), 1125000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(11), 1150000 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(12), 1175000 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(13), 1187500 },
...
static struct acpu_level tbl_fast[] __initdata = {
	...
	{ 1, {   162000, HFPLL, 0, 0x0C }, L2(0),   800000 }, 
	{ 1, {   270000, HFPLL, 0, 0x14 }, L2(0),   825000 }, 
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   850000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(4),   875000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),   900000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(6),   925000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(7),   975000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(8),  1000000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(9),  1025000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(10), 1075000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(11), 1100000 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(12), 1125000 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(13), 1137500 },
...
static struct acpu_level tbl_faster[] __initdata = {
	...
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),   900000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(6),   925000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(7),   962500 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(8),   975000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(9),  1000000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(10), 1050000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(11), 1075000 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(12), 1100000 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(13), 1112500 },
