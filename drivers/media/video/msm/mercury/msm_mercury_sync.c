...
/*************** queue helper ****************/
static void msm_mercury_q_init(char const *name, struct msm_mercury_q *q_p)
{
...
static void *msm_mercury_q_out(struct msm_mercury_q *q_p)
{
	unsigned long flags;
...
static int msm_mercury_q_in(struct msm_mercury_q *q_p, void *data)
{
	unsigned long flags;
...
static int msm_mercury_q_in_buf(struct msm_mercury_q *q_p,
...
static int msm_mercury_q_wait(struct msm_mercury_q *q_p)
{
...
static int msm_mercury_q_wakeup(struct msm_mercury_q *q_p)
{
	MCR_DBG("%s:%d] %s\n", __func__, __LINE__, q_p->name);
	wake_up(&q_p->wait);
	return 0;
...
static int msm_mercury_q_wr_eoi(struct msm_mercury_q *q_p)
{
...
static int msm_mercury_q_wr_err(struct msm_mercury_q *q_p)
{
	MCR_DBG("%s:%d] Wake up %s\n", __func__, __LINE__, q_p->name);
...
static int msm_mercury_q_unblock(struct msm_mercury_q *q_p)
{
	MCR_DBG("%s:%d] Wake up %s\n", __func__, __LINE__, q_p->name);
...
static void msm_mercury_q_cleanup(struct msm_mercury_q *q_p)
{
	void *data;
	MCR_DBG("\n%s:%d] %s\n", __func__, __LINE__, q_p->name);
	do {
